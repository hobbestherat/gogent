	...
	tr.Register(&Tool{
		...
		InputSchema: map[string]interface{}{
			...
			"properties": map[string]interface{}{
				...
				"message": map[string]interface{}{"type": []string{"string", "null"}, "description": "Commit message (required for commit; null otherwise)."},
				"branch":  map[string]interface{}{"type": []string{"string", "null"}, "description": "Branch name (required for create_branch; null otherwise)."},
				"paths": map[string]interface{}{
					"type":        []string{"array", "null"},
					"items":       map[string]interface{}{"type": "string"},
					"description": "Files to act on (null when not applicable). commit: stage these before committing. diff: limit to these. restore: paths to discard (required).",
				},
				"staged":    map[string]interface{}{"type": []string{"boolean", "null"}, "description": "diff: show staged changes instead of unstaged."},
				"all":       map[string]interface{}{"type": []string{"boolean", "null"}, "description": "commit: stage all tracked modified files before committing."},
				"max_count": map[string]interface{}{"type": []string{"integer", "null"}, "description": "log: number of commits to show (default 20)."},
			},
