	...
	g.toolRegistry.Register(&tool.Tool{
		...
		InputSchema: map[string]interface{}{
			...
			"properties": map[string]interface{}{
				...
				"offset":     map[string]interface{}{"type": "integer", "description": "1-based line number to start reading from (default 1). Set it to a previous read's next_offset to page through a large file."},
				"limit":      map[string]interface{}{"type": "integer", "description": "Maximum number of lines to return (default 2000). The read is also bounded by max_length, whichever limit is reached first."},
				"max_length": map[string]interface{}{"type": "integer", "description": "Maximum number of bytes of content to return (default 102400, i.e. 100 KB). The slice is cut on a UTF-8 boundary; raise it to pull more of a dense file in one call."},
			},
