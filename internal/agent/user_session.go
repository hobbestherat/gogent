...
calc:
  	description: Evaluate a math expression and get the exact result. Operators + - * / %, power (** or ^), unary minus, parentheses. Functions sqrt cbrt pow exp log log2 log10 sin cos tan asin acos atan atan2 (radians) deg rad sinh cosh tanh abs floor ceil round trunc sign mod min max factorial gcd lcm mean median. Constants pi e tau phi sqrt2 c G g h hbar k Na R sigma epsilon0 mu0 echarge me mp. Integers print cleanly (2+2 -> 4); fractionals keep full precision.
